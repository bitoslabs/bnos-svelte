...
<div class="grid grid-cols-1 gap-6 lg:grid-cols-[15rem_1fr]">
	...
	<aside
		class="hidden lg:sticky lg:top-20 lg:block lg:h-fit lg:max-h-[calc(100vh-6rem)] lg:overflow-y-auto lg:pr-1 lg:pb-4"
	>
		...
		<div class="mx-auto w-full max-w-5xl">
			{#if !isIndex}
				<a
					...
					class="mb-4 inline-flex items-center gap-1.5 rounded-lg px-2 py-1.5 text-[13px] font-semibold text-[var(--ui-text-muted)] transition-colors hover:bg-[var(--ui-bg-accented)] hover:text-[var(--ui-text)] lg:hidden"
				>
