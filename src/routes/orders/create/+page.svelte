						...
						{#if showCustomerSelect}
							...
							>
								...
								{#if customers.length === 0}
									<div class="px-3 py-4 text-center text-[13px] text-[var(--ui-text-dimmed)]">
										No customers found.
									</div>
								{/if}
							</div>
				...
				<div class="space-y-3 px-5 py-4">
					...
					<div class="flex items-center gap-2">
						<div class="relative flex-1">
							<div
								class="inline-flex w-full items-center gap-2 rounded-lg border border-[var(--ui-border)] bg-[var(--ui-bg-muted)] px-3 py-2 transition-colors focus-within:border-primary-500"
							>
