...
/** `brand` reuses the custom teal scale declared in app.css @theme. */
...
/** Standard Tailwind color scales (the same data Nuxt UI derived accents from). */
const tailwind: Record<string, Scale> = {
	red: {
		'50': '#fef2f2',
		'100': '#fee2e2',
		'200': '#fecaca',
...
export const accentScale: Record<string, Scale> = { brand: brandScale, ...tailwind };
...
export type NeutralKey = keyof typeof neutralScale;

export const accentOptions: AccentOption[] = [
	{ key: 'brand', label: 'Teal', hex: '#0d9488' },
...
export const neutralOptions: NeutralOption[] = [
...
export type Surface = 'macos' | 'clean' | 'paper' | 'soft' | 'contrast';
export const surfaceOptions: { key: Surface; label: string }[] = [
...
export type SurfaceTint = 'subtle' | 'balanced' | 'tinted';
export const surfaceTintOptions: { key: SurfaceTint; label: string }[] = [
...
export const fontSizeOptions: { key: FontSize; label: string; value: string }[] = [
	...
	{ key: 'lg', label: 'Large', value: '17.5px' }
];

export type Density = 'normal' | 'compact';
export const densityOptions: { key: Density; label: string }[] = [
	{ key: 'normal', label: 'Normal' },
	{ key: 'compact', label: 'Compact' }
];

export type Radius = 'none' | 'sm' | 'md' | 'lg';
export const radiusOptions: { key: Radius; label: string; value: string }[] = [
	{ key: 'none', label: 'Sharp', value: '0rem' },
	{ key: 'sm', label: 'Soft', value: '0.375rem' },
	{ key: 'md', label: 'Round', value: '0.75rem' },
	{ key: 'lg', label: 'Pillowy', value: '1rem' }
];
